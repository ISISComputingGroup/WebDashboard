...
export default function NavBar() {
  return (
    <>
      <div class="bg-gray-100 shadow w-full hidden sm:flex  ">
        <div class="container mx-auto px-4 w-full max-w-7xl">
          <div class="flex justify-between items-center py-4 w-full">
            <div class="flex  justify-start w-full ">
              <Link href="/" class="flex items-center justify-center ">
                <img src="/ibex_logo.png" alt="IBEX Logo" class="h-16 w-auto" />
              </Link>
              <div class="flex flex-col justify-center items-center divide-y">
                <Link
                  href="/"
                  class="text-left text-lg w-full transition-all duration-200 font-semibold  py-2 text-black hover:text-blue-600"
                >
                  IBEX Web Dashboard
                </Link>
                <div class="flex items-start  justify-left text-left w-full text-lg">
                  <Link
                    href="/instruments"
                    class="text-gray-700  font-semibold  text-left hover:text-blue-600 mr-4 transition-all duration-200"
                  >
                    Instruments
                  </Link>
                  <Link
                    href="/how-to-use"
                    class="text-gray-700  font-semibold  text-left hover:text-blue-600 transition-all duration-200"
                  >
                    How to use
                  </Link>
                </div>
            ...
            <svg
              fill="currentColor"
              class="h-16 w-auto text-[#18334b] hover:text-blue-600 transition-all duration-200"
      ...
      {/* MOBILE NAV BAR */}
      <div class="bg-gray-100 shadow w-full flex sm:hidden   ">
        <div class="container mx-auto px-4 w-full max-w-7xl">
          <div class="flex justify-between items-center py-4 w-full">
            <div class="flex flex-col sm:flex-row items-start  sm:items-center justify-start w-full ">
              <div class="flex flex-col justify-center items-center divide-y">
                <Link
                  href="/"
                  class="text-left text-lg w-full transition-all duration-200 font-semibold  py-2 text-black hover:text-blue-600"
