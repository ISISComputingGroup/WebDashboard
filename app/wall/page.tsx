...
export default function WallDisplay() {
  ...
  const [TS1Data, setTS1Data] = useState<Array<instrumentStatus>>([]);
  const [TS2Data, setTS2Data] = useState<Array<instrumentStatus>>([]);
  const [miscData, setMiscData] = useState<Array<instrumentStatus>>([]);
  ...
  }, [TS1Data, TS2Data, lastJsonMessage, miscData]);
