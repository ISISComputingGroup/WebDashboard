...
export default function WallDisplay() {  
  ...
  const [TS1Data, setTS1Data] = useState<Array<IfcInstrumentStatus>>([
  ...
  const [TS2Data, setTS2Data] = useState<Array<IfcInstrumentStatus>>(
    [
  ...
  const [miscData, setMiscData] = useState<Array<IfcInstrumentStatus>>(
    [
  ...
  useEffect(() => {
    ...
    if (!instrument) {
      ...
      if (TS1Data.find((instrument) => instrument.pv === pv)) {
        TS1Data.find((instrument) => instrument.pv === pv)!.status = value;
      } else if (TS2Data.find((instrument) => instrument.pv === pv)) {
        TS2Data.find((instrument) => instrument.pv === pv)!.status = value;
      } else if (miscData.find((instrument) => instrument.pv === pv)) {
        miscData.find((instrument) => instrument.pv === pv)!.status = value;
      }
    }
