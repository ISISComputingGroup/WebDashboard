...
test("findPVinDashboard finds a IfcPV in the dashboard and returns it", () => {
    ...
    let dashboard: DashboardArr = [
        ...
        [
            ...
            [{pvaddress: "", value:"Users:" }, {pvaddress:`${prefix}DAE:_USERNAME`}]
        ],
        //column 1
        [
            [pvToTestFor, {pvaddress:`${prefix}1:1:VALUE`}],
            [{pvaddress:`${prefix}2:1:LABEL`}, {pvaddress:`${prefix}2:1:VALUE`}],
            [{pvaddress:`${prefix}3:1:LABEL`}, {pvaddress:`${prefix}3:1:VALUE`}],
        ],
        //column 2
        [
            [{pvaddress:`${prefix}1:2:LABEL`}, {pvaddress:`${prefix}1:2:VALUE`}],
            [{pvaddress:`${prefix}2:2:LABEL`}, {pvaddress:`${prefix}2:2:VALUE`}],
            [{pvaddress:`${prefix}3:2:LABEL`}, {pvaddress:`${prefix}3:2:VALUE`}]
        ]
    ]
